                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl border border-gray-100 shadow-xl z-50 max-h-[300px] overflow-y-auto flex flex-col p-2 animate-in fade-in slide-in-from-top-2">
                    ...
                    {trainers.map((trainer) => (
                        <div
                            ...
                            className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-colors ${selectedTrainerId === trainer.id
                                    ? "bg-gray-900 text-white"
                                    : "hover:bg-gray-50 text-gray-700"
                                }`}
                        >
                            <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${selectedTrainerId === trainer.id
                                        ? "bg-white/20"
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden">
                                ...
                                <span
                                    className={`text-[10px] truncate ${selectedTrainerId === trainer.id
                                            ? "text-white/60"
                                            : "text-gray-400"
                                        }`}
                                >
