    ...
    <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-sm border border-gray-100 flex flex-col h-full">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <span className="text-xs text-gray-400 font-medium">than last month</span>
          </div>
        </div>
      ...
      <div className="mt-auto">
        <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
          Memberships <span className="text-gray-400 font-medium font-normal">| Total 3 plans</span>
        </h3>
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="p-4 rounded-2xl border border-gray-100 bg-gray-50 hover:border-gray-300 transition-colors cursor-pointer">
            ...
            <div className="text-xs font-medium text-gray-400 mb-2">Limit is 1K a month</div>
          ...
          <div className="p-4 rounded-2xl border border-gray-100 bg-gray-50 hover:border-gray-300 transition-colors cursor-pointer">
            ...
            <div className="text-xs font-medium text-gray-400 mb-2">Limit is 500 a month</div>
            <div className="text-[10px] font-bold text-[#33D073]">Active</div>
          </div>
          ...
          <div className="p-4 rounded-2xl border border-gray-100 bg-gray-50 hover:border-gray-300 transition-colors cursor-pointer">
            ...
            <div className="text-xs font-medium text-gray-400 mb-2">Limit is 200 a month</div>
...
function OptionsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 hover:text-gray-900 transition-colors">
