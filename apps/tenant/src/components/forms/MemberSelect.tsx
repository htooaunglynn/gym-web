                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl border border-gray-100 shadow-xl z-50 max-h-[300px] overflow-y-auto flex flex-col p-2 animate-in fade-in slide-in-from-top-2">
                    ...
                    {members.map((member) => (
                        <div
                            ...
                            className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-colors ${selectedMemberId === member.id
                                    ? "bg-gray-900 text-white"
                                    : "hover:bg-gray-50 text-gray-700"
                                }`}
                        >
                            <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${selectedMemberId === member.id
                                        ? "bg-white/20"
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden">
                                ...
                                <span
                                    className={`text-[10px] truncate ${selectedMemberId === member.id
                                            ? "text-white/60"
                                            : "text-gray-400"
                                        }`}
                                >
